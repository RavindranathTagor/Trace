...
export const NIMBUS_DECISIONS: Decision[] = [
  ...
  },
  {
    ...
    tag: "pricing",
    graphTerms: ["pricing", "flat", "tier", "Ashwini"],
  },
  ...
  },
  {
    ...
    reverses: "db-selfpg",
    tag: "infra",
    graphTerms: ["Neon", "managed", "Postgres", "database", "Ravindra"],
  },

  {
    id: "db-mongo",
    lane: "Database",
    title: "Use MongoDB for new services (schema flexibility)",
    date: "2026-01-10",
    quarter: "Q1 2026",
    owner: "Sandesh",
    role: "Backend",
  ...
  {
    id: "db-postgres-standard",
    lane: "Database",
    title: "Standardize ALL new services on PostgreSQL",
    date: "2026-01-15",
    quarter: "Q1 2026",
    owner: "Ravindra",
    role: "Infra",
  ...
  },
  {
    ...
    tag: "api",
    graphTerms: ["REST", "SDK", "API", "Pushpa"],
  },
  ...
  // ── Ownership / bus-factor ───────────────────────────────────────────────
  {
    id: "own-auth",
    lane: "Ownership",
    title: "Auth & billing security owned solely by Ravindra",
    date: "2026-03-05",
    quarter: "Q1 2026",
    owner: "Ravindra",
    role: "Staff Eng",
  ...
  // ── Reliability (a DUPLICATE-work pair) ──────────────────────────────────
  {
    ...
    status: "current",
    tag: "reliability",
    graphTerms: ["retry queue", "Sandesh", "payments"],
  },
  {
    ...
    status: "current",
    tag: "reliability",
    graphTerms: ["retry queue", "Pushpa", "platform"],
  },
